...
_G.packer_plugins = {
  ...
  ["formatter.nvim"] = {
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/formatter.nvim",
  ...
  ["gv.vim"] = {
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/gv.vim",
  ...
  ["rose-pine"] = {
    ...
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/home/felix/.local/share/nvim/site/pack/packer/start/vim-commentary",
